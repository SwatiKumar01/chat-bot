...
public class OrderLineHold implements Serializable
{

    @JsonProperty("Actions")
    private Actions______________ actions;
    ...
    private Extended______________ extended;
    ...
    private Translations____________ translations;
    ...
    private Messages___________ messages;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();
    private final static long serialVersionUID = -6093404754800347506L;

    @JsonProperty("Actions")
    public Actions______________ getActions() {
        return actions;
    }

    @JsonProperty("Actions")
    public void setActions(Actions______________ actions) {
    ...
    @JsonProperty("Extended")
    public Extended______________ getExtended() {
        return extended;
    }

    @JsonProperty("Extended")
    public void setExtended(Extended______________ extended) {
    ...
    @JsonProperty("Translations")
    public Translations____________ getTranslations() {
        return translations;
    }

    @JsonProperty("Translations")
    public void setTranslations(Translations____________ translations) {
    ...
    @JsonProperty("messages")
    public Messages___________ getMessages() {
        return messages;
    }

    @JsonProperty("messages")
    public void setMessages(Messages___________ messages) {
