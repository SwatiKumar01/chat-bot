...
public class OrderLineTaxDetail implements Serializable
{

    @JsonProperty("Actions")
    private Actions______________________ actions;
    @JsonProperty("CreatedBy")
    private String createdBy;
    @JsonProperty("CreatedTimestamp")
    private String createdTimestamp;
    @JsonProperty("Extended")
    private Extended______________________ extended;
    ...
    private Translations____________________ translations;
    ...
    private Messages___________________ messages;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();
    private final static long serialVersionUID = 2503847721702421064L;

    @JsonProperty("Actions")
    public Actions______________________ getActions() {
        return actions;
    }

    @JsonProperty("Actions")
    public void setActions(Actions______________________ actions) {
    ...
    @JsonProperty("Extended")
    public Extended______________________ getExtended() {
        return extended;
    }

    @JsonProperty("Extended")
    public void setExtended(Extended______________________ extended) {
    ...
    @JsonProperty("HeaderTaxDetailId")
    public String getHeaderTaxDetailId() {
        return headerTaxDetailId;
    }

    @JsonProperty("HeaderTaxDetailId")
    public void setHeaderTaxDetailId(String headerTaxDetailId) {
    ...
    @JsonProperty("Translations")
    public Translations____________________ getTranslations() {
        return translations;
    }

    @JsonProperty("Translations")
    public void setTranslations(Translations____________________ translations) {
    ...
    @JsonProperty("messages")
    public Messages___________________ getMessages() {
        return messages;
    }

    @JsonProperty("messages")
    public void setMessages(Messages___________________ messages) {
